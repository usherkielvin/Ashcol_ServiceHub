...
public class CalendarAdapter extends RecyclerView.Adapter<CalendarAdapter.CalendarViewHolder> {
    ...
    public static class CalendarDay {
        ...
        public List<EmployeeScheduleResponse.ScheduledTicket> getScheduledTickets() { return scheduledTickets; }
        public void setScheduledTickets(List<EmployeeScheduleResponse.ScheduledTicket> tickets) { this.scheduledTickets = tickets; }
    ...
    static class CalendarViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(CalendarDay day) {
            ...
            if (day.getScheduledTickets() != null && !day.getScheduledTickets().isEmpty()) {
                ...
                if (tickets.size() >= 1) {
                    ...
                    setColorByPriority(indicator1, tickets.get(0));
                }
                if (tickets.size() >= 2) {
                    indicator2.setVisibility(View.VISIBLE);
                    setColorByPriority(indicator2, tickets.get(1));
                }
                if (tickets.size() >= 3) {
                    indicator3.setVisibility(View.VISIBLE);
                    setColorByPriority(indicator3, tickets.get(2));
                }
            } else {
        ...
        private void setColorByPriority(View indicator, EmployeeScheduleResponse.ScheduledTicket ticket) {
            ...
            } else if (priority.equals("urgent") || priority.equals("high")) {
                indicator.setBackgroundResource(R.drawable.cr100b00000012); // Red
