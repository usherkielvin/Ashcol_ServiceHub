            ...
            public void onResponse(Call<EmployeeResponse> call, Response<EmployeeResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (employeeResponse.isSuccess()) {
                        cachedBranchName = employeeResponse.getBranch() != null ? 
                            employeeResponse.getBranch() : "No Branch Assigned";
                        cachedEmployees = employeeResponse.getEmployees() != null ? 
                            new ArrayList<>(employeeResponse.getEmployees()) : new ArrayList<>();
